  ...
  if (newEvent == null) {
    ...
    if (metadata) {
      ...
      if (value) {
        ...
        if(imagePath){
          const imageURL =
      "https://" + event.params.eventDataCID + ".ipfs.w3s.link/" + imagePath.toString();
          newEvent.imageURL = imageURL;
        } else {
          const fallbackURL = "https://bafybeibssbrlptcefbqfh4vpw2wlmqfj2kgxt3nil4yujxbmdznau3t5wi.ipfs.w3s.link/event.png";
